...
namespace MariEtFemme.Tools
{
    public class MaskedTextBox : TextBox
    {
        ...
        public static StringBuilder FormatForCNPJ(string sb)
        {
            StringBuilder sb2 = new StringBuilder();
            ...
            if (sb.Length > 9) sb2.Append(sb.Substring(9, 1));
            if (sb.Length > 10) sb2.Append(sb.Substring(10, 1));
            if (sb.Length > 11) sb2.Append(sb.Substring(11, 1));
            if (sb.Length > 11) sb2.Append("-");

            if (sb.Length > 12) sb2.Append(sb.Substring(12, 1));
            if (sb.Length > 13) sb2.Append(sb.Substring(13, 1));
