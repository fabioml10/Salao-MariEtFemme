...
namespace MariEtFemme.Tools
{
    public static class Encryption
    {
        ...
        /// </summary>     
        private static byte[] bIV = { 0x59, 0x18, 0xD1, 0xDD, 0xDE, 0x3C, 0xF2, 0xCC, 0x74, 0x99, 0x19, 0x5C, 0x53, 0x29, 0xCB, 0xBC };
        ...
        /// </summary>     
        private const string cryptoKey = "F3JpcHRvDZJhZmlVcyBBjb20gUml9RmRhZWwgLyCCft=";
        ...
        public static string Encrypt(string text)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(text))
                {
                    ...
                    // Lembre-se: chaves possíves: 128 (16 caracteres), 192 (24 caracteres) e 256 (32 caracteres)                
